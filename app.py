...
if st.session_state.gene_name and st.session_state.variant_str:
    ...
    captions = {
        ...
        "IDEO_BLOCK": "Earlier, we showed the chromosome in a simplified way, with the p arm on top and the q arm on the bottom. Scientists usually show the chromosome as one vertical shape, with light and dark stripes called bands. These bands help pinpoint exactly where a gene is. That’s the view you see here. {gene_input}'s location is marked below",
